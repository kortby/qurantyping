...
const tashkeelActive = ref(!!props.race.tashkeel);
...
const score = useTypingScore(text, input, startedAt, tashkeelActive);
...
function applySnapshot(e) {
    ...
    if (e.tashkeel != null) tashkeelActive.value = e.tashkeel;
